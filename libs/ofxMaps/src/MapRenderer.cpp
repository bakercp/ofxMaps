//#include "ofx/Maps/MapRenderer.h"
...
//
//
//void Map::setup(std::shared_ptr<BaseMapTileProvider> provider, int width, int height)
//{
//	_provider = provider;
//
...
//	TileCoordinate topLeft = pointToTileCoordinate(ofVec2d::zero()).zoomTo(baseZoom);
//	TileCoordinate topRight = pointToTileCoordinate(ofVec2d(_size.x, 0)).zoomTo(baseZoom);
//	TileCoordinate bottomLeft = pointToTileCoordinate(ofVec2d(0, _size.y)).zoomTo(baseZoom);
//	TileCoordinate bottomRight = pointToTileCoordinate(_size).zoomTo(baseZoom);
//
//
